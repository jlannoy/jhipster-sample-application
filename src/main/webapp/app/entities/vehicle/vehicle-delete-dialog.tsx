...
export const VehicleDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const handleClose = () => {
    props.history.push('/vehicle' + props.location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.vehicle.delete.question">Are you sure you want to delete this Vehicle?</ModalBody>
      <ModalFooter>
