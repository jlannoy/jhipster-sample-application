              ...
              <tbody>
                {taskList.map((task, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{task.date ? <TextFormat type="date" value={task.date} format={APP_DATE_FORMAT} /> : null}</td>
                    <td>{task.title}</td>
                    <td>{task.amount}</td>
                    <td>{task.vehicle ? <Link to={`vehicle/${task.vehicle.id}`}>{task.vehicle.id}</Link> : ''}</td>
