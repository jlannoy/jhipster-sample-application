    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{taskEntity.date ? <TextFormat value={taskEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
          ...
          <dd>{taskEntity.amount}</dd>
          <dt>Vehicle</dt>
          <dd>{taskEntity.vehicle ? taskEntity.vehicle.id : ''}</dd>
        </dl>
