...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().date(DEFAULT_DATE).title(DEFAULT_TITLE).amount(DEFAULT_AMOUNT);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().date(UPDATED_DATE).title(UPDATED_TITLE).amount(UPDATED_AMOUNT);
        return task;
    }
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.date(UPDATED_DATE).title(UPDATED_TITLE).amount(UPDATED_AMOUNT);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.date(UPDATED_DATE).title(UPDATED_TITLE).amount(UPDATED_AMOUNT);
